  ...
  return (
    ...
    >
      <div className="flex items-center mb-6">
        <Sparkles className="h-6 w-6 text-teal-600 mr-3" aria-hidden="true" />
        <h2
          id="related-articles-heading"
          className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-teal-600 to-teal-600 bg-clip-text text-transparent"
        >
          Related Articles
        </h2>
      </div>
          ...
          >
            ...
            >
              ...
              <div className="p-4 h-full flex flex-col">
                <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-2 hover:text-teal-600 transition-colors">
                  {relatedBlog.title}
                </h3>
                {relatedBlog.excerpt && (
