...
export default function BlogDetails({ slug }) {
  ...
  return (
    <main className="pt-12 min-h-screen bg-gradient-to-r from-teal-50/30 to-teal-50/30">
      <div
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            >
              <div className="flex flex-wrap items-center gap-3 text-sm">
                <span className="px-3 py-1 rounded-full bg-teal-600 text-white font-medium">
                  {blog?.category?.name}
                </span>
              ...
              <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                <div className="flex items-center gap-3">
                  {blog.author?.full_name && (
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-teal-600 to-teal-600 flex items-center justify-center text-white font-semibold">
            ...
            <motion.article
              ...
              className="prose prose-lg prose-headings:text-gray-900 prose-p:text-gray-600 max-w-none bg-gradient-to-br from-teal-50 to-teal-50 rounded-xl p-6 shadow-md"
            ...
            <div className="sticky top-24 space-y-8">
              ...
              >
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 rounded-full bg-teal-600 text-white text-sm font-medium hover:bg-teal-700 transition-colors"
                >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {blog.tags.map((tag, index) => (
                      <Link
                        key={index}
                        href={`/tag/${tag.slug}`}
                        className="inline-flex items-center gap-1 px-3 py-1.5 rounded-full bg-white/80 text-teal-600 text-sm font-medium hover:shadow-md transition-shadow"
      ...
      {isVisible && (
        <div className="fixed bottom-8 left-8 z-50">
          <motion.button
            ...
            transition={{ duration: 0.5 }}
            onClick={handleGoBack}
            className="flex items-center gap-2 px-4 py-2 rounded-full bg-teal-600 text-white text-sm font-medium hover:bg-teal-700 transition-colors shadow-lg"
          >
            <ArrowLeft className="h-4 w-4" aria-hidden="true" />
            Back to Blogs
          </motion.button>
