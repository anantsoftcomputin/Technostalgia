            ...
            <div ref={contentRef}>
              ...
              >
                <div className="flex flex-wrap items-center gap-3 text-sm">
                  <span className="px-3 py-1 rounded-full bg-gradient-to-r from-teal-600 to-teal-600 text-white font-medium">
                    {blog.category?.name}
                  </span>
                ...
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-teal-600 to-teal-600 bg-clip-text text-transparent">
                  {blog.title}
                </h1>
            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                {blog.tags.map((tag, index) => (
                  <span
                    key={index}
                    className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-teal-100 text-teal-700 text-sm font-medium"
                  >
