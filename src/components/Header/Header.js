...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-teal-50 text-gray-700 print:hidden">
        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex-shrink-0">
            ...
            >
              ...
              />
              <span className="text-2xl font-bold text-teal-700 transition-colors">
                Techsnostalgia
              </span>
            </Link>
          </div>
          ...
          <div className="flex md:hidden">
            <button
              ...
              className="p-2 rounded-md text-gray-700 hover:text-teal-700 transition-colors duration-200"
