    ...
    const fetchRelatedBlogs = async () => {
      ...
      try {
        const response = await ajaxCall(
          `/posts-category/?site_domain=techsnostalgia.com&category_slug=${slug}`,
          { method: "GET" }
        );
                  ...
                  <Link href={`/${blog.slug}`} className="group">
                    ...
                    <div className="p-6 flex flex-col flex-grow">
                      ...
                      <div className="flex items-center gap-3 my-3">
                        <div className="w-8 h-8 rounded-full border-2 border-teal-100 flex items-center justify-center bg-teal-100 text-teal-600 font-semibold">
