        ...
        <div className="relative py-16 sm:py-20">
          ...
          <div className="relative max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <p className="inline-block border border-teal-600 py-1 px-3 rounded-full bg-gradient-to-br from-teal-700 via-teal-600 to-teal-700 bg-clip-text text-transparent font-medium text-sm mb-4 shadow-sm">
                CONNECT WITH US
              </p>
            ...
            <div className="grid md:grid-cols-12 gap-8 lg:gap-10 items-start">
              ...
              >
                ...
                <form onSubmit={handleSubmit(onSubmit)} noValidate>
                        ...
                        <Controller
                          ...
                          render={({ field }) => (
                            <input
                              ...
                              id="name"
                              autoComplete="name"
                              className="pl-10 w-full py-3 px-4 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-colors"
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <textarea
                          ...
                          id="message"
                          rows="5"
                          className="w-full py-3 px-4 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-colors"
                  ...
                  <button
                    type="submit"
                    className="w-full py-3 px-6 bg-teal-600 hover:bg-teal-700 text-white font-medium rounded-lg shadow-lg hover:shadow-xl transition-all flex items-center justify-center group focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2"
                  >
                    Send Message
                    <Send
                ...
                >
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      <div
                        className="flex-shrink-0 p-3 bg-teal-600 rounded-full mr-4"
                        aria-hidden="true"
                      >
                ...
                >
                  ...
                  <ul className="space-y-3">
                    <li>
                      ...
                      >
                        <ArrowRight
                          className="h-4 w-4 mr-2 text-teal-500 transform transition-transform group-hover:translate-x-1 group-hover:text-teal-500"
                          aria-hidden="true"
                        />
                    ...
                    <li>
                      ...
                      >
                        <ArrowRight
                          className="h-4 w-4 mr-2 text-teal-500 transform transition-transform group-hover:translate-x-1"
                          aria-hidden="true"
                        />
