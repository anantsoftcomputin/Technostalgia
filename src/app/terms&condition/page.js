            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-gray-600">
                  By accessing and using techsnostalgia.com (hereinafter referred to
              ...
              <div className="p-6">
                <div className="space-y-4">
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-2">
                    <li>
                      All content on techsnostalgia.com, including but not limited
                      to text, images, graphics, logos, and software, is the
                      property of techsnostalgia.com or its licensors and is
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-2">
                    <li>
                      If you submit comments or other user-generated content,
                      you grant us a non-exclusive, royalty-free, perpetual, and
                      worldwide license to use, reproduce, modify, and
                      distribute that content. You are responsible for ensuring
                      your user-generated content does not violate any
              ...
              <div className="p-6">
                <div className="space-y-4">
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-2">
                    ...
                    <li>
                      Engage in any activity that could damage or impair our
                      Site.
                    </li>
                  </ul>
                  <h3 className="font-semibold text-gray-900 mt-4">
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                <div className="space-y-4">
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-2">
                    <li>
                      The content on techsnostalgia.com is provided for
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                <div className="space-y-4">
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-2">
                    <li>
                      To the fullest extent permitted by law, techsnostalgia.com and
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-2">
                    <li>
                      You agree to indemnify and hold techsnostalgia.com harmless
                ...
                <div className="space-y-4">
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-2">
                    <li>
                      ...
                      at any time. We will notify you of any changes by posting
                ...
                <div className="space-y-4">
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-2">
                    <li>
                      ...
                      without notice, for any reason, including but not limited
                ...
                <div className="space-y-4">
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-2">
                    <li>
                      ...
                      Conditions shall be resolved in the courts of Vadodara,
                      Gujarat, India.
                    </li>
                  </ul>
                </div>
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="mt-2 text-purple-600">
                  ...
                  <br />
                  Contact: Available on techsnostalgia.com
                </p>
              </div>
            </div>
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-gray-600">
                  ...
                  between you and techsnostalgia.com regarding your use of our Site,
