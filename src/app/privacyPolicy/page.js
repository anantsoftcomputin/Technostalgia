            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-gray-600">
                  ...
                  Site. By using techsnostalgia.com, you agree to the terms of this
                  Privacy Policy.
                </p>
              </div>
            </div>
              ...
              <div className="p-6">
                <div className="space-y-4">
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-2">
                    ...
                    <li>To prevent fraud and protect our Site's security.</li>
                    <li>
                      To display your profile picture within your comments.
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-2">
                    <li>
                      ...
                      comments automatically instead of holding them in a
                      moderation queue.
                    </li>
                  </ul>
                </div>
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="mt-2 text-purple-600">
                  Email: techsnostalgia@gmail.com
                  <br />
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-gray-600 ">
                  ...
                  collect, the right to delete your personal information, and
