                ...
                <div className="space-y-4">
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-2">
                    <li>
                      ...
                      the property of techsnostalgia.com or its licensors and is
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                <div className="space-y-4">
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-2">
                    <li>
                      To the fullest extent permitted by law, techsnostalgia.com
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-2">
                    <li>
                      You agree to indemnify and hold techsnostalgia.com
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-gray-600">
                  ...
                  between you and techsnostalgia.com regarding your use of our
